...
module Bundler
  ...
  SPECS        = [
        ...
        {:load_paths=>["/usr/local/lib/ruby/gems/1.8/gems/activerecord-2.3.5/lib"], :loaded_from=>"/usr/local/lib/ruby/gems/1.8/specifications/activerecord-2.3.5.gemspec", :name=>"activerecord"},
        {:load_paths=>["/usr/local/lib/ruby/gems/1.8/gems/builder-2.1.2/lib"], :loaded_from=>"/usr/local/lib/ruby/gems/1.8/specifications/builder-2.1.2.gemspec", :name=>"builder"},
        {:load_paths=>["/Users/nzalabak1/.bundle/ruby/1.8/gems/libxml-ruby-1.1.3/lib", "/Users/nzalabak1/.bundle/ruby/1.8/gems/libxml-ruby-1.1.3/ext/libxml"], :loaded_from=>"/Users/nzalabak1/.bundle/ruby/1.8/specifications/libxml-ruby-1.1.3.gemspec", :name=>"libxml-ruby"},
        {:load_paths=>["/Users/nzalabak1/.bundle/ruby/1.8/gems/happymapper-0.3.0/lib"], :loaded_from=>"/Users/nzalabak1/.bundle/ruby/1.8/specifications/happymapper-0.3.0.gemspec", :name=>"happymapper"},
        {:load_paths=>["/Users/nzalabak1/.bundle/ruby/1.8/gems/cafepress-search-1.1.0/lib"], :loaded_from=>"/Users/nzalabak1/.bundle/ruby/1.8/specifications/cafepress-search-1.1.0.gemspec", :name=>"cafepress-search"},
        ...
        {:load_paths=>["/usr/local/lib/ruby/gems/1.8/gems/rack-test-0.5.4/lib"], :loaded_from=>"/usr/local/lib/ruby/gems/1.8/specifications/rack-test-0.5.4.gemspec", :name=>"rack-test"},
        {:load_paths=>["/usr/local/lib/ruby/gems/1.8/gems/rack-throttle-0.3.0/lib"], :loaded_from=>"/usr/local/lib/ruby/gems/1.8/specifications/rack-throttle-0.3.0.gemspec", :name=>"rack-throttle"},
        {:load_paths=>["/usr/local/lib/ruby/gems/1.8/gems/rspec-1.3.0/lib"], :loaded_from=>"/usr/local/lib/ruby/gems/1.8/specifications/rspec-1.3.0.gemspec", :name=>"rspec"},
        ...
        {:load_paths=>["/usr/local/lib/ruby/gems/1.8/gems/sinatra-outputbuffer-0.1.0/lib"], :loaded_from=>"/usr/local/lib/ruby/gems/1.8/specifications/sinatra-outputbuffer-0.1.0.gemspec", :name=>"sinatra-outputbuffer"},
        {:load_paths=>["/usr/local/lib/ruby/gems/1.8/gems/sinatra-cache-0.3.4/lib"], :loaded_from=>"/usr/local/lib/ruby/gems/1.8/specifications/sinatra-cache-0.3.4.gemspec", :name=>"sinatra-cache"},
        {:load_paths=>["/usr/local/lib/ruby/gems/1.8/gems/sinatra-respond_to-0.4.0/lib"], :loaded_from=>"/usr/local/lib/ruby/gems/1.8/specifications/sinatra-respond_to-0.4.0.gemspec", :name=>"sinatra-respond_to"},
